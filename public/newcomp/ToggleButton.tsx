    ...
    <div className="tb-root" style={{ minHeight: "100vh", background: "#F5F3EE", padding: "40px 24px", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
        ...
        <Section title="Exclusive selection">
          <ToggleButtonGroup value={alignment} exclusive onChange={(_, v) => setAlignment(v as string | null)} aria-label="alinhamento de texto">
        ...
        <Section title="Sizes">
          {(["small", "medium", "large"] as Size[]).map((sz) => (
            <ToggleButtonGroup key={sz} value={alignment} exclusive onChange={(_, v) => setAlignment(v as string | null)} size={sz} aria-label={sz}>
        ...
        <Section title="Colors">
          {(["standard","primary","secondary","error","info","success","warning"] as Color[]).map((c) => (
            <ToggleButtonGroup key={c} value={color} exclusive onChange={(_, v) => v && setColor(v as string)} color={c} aria-label={c}>
        ...
        <Section title="Vertical orientation">
          <ToggleButtonGroup orientation="vertical" value={view} exclusive onChange={(_, v) => v && setView(v as string)} aria-label="visualização">
        ...
        <Section title="Enforce value set (always one active)">
          <ToggleButtonGroup value={alignEnforce} exclusive
            onChange={(_, v) => { if (v !== null) setAlignEnforce(v as string); }}
        ...
        <Section title="Full width">
          <div style={{ width: "100%", maxWidth: 400 }}>
            <ToggleButtonGroup value={alignment} exclusive onChange={(_, v) => setAlignment(v as string | null)} fullWidth color="primary" aria-label="alinhamento full width">
        ...
        <Section title="Text labels">
          <ToggleButtonGroup value={alignment} exclusive onChange={(_, v) => setAlignment(v as string | null)} color="primary" size="small" aria-label="plataforma">
