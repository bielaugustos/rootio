...
const CSS = `
  ...
  @media (prefers-color-scheme: dark) {
    .tl-root {
      --tl-bg: #1c1c1e; --tl-text: #f0f0f0;
      --tl-text-secondary: #888; --tl-border: #3a3a3c;
  ...
  .tl-body {
    font-size: 13px; color: var(--tl-text-secondary);
    margin: 0; line-height: 1.5;
  }
  .tl-time {
    font-size: 12px; color: var(--tl-text-secondary);
    line-height: 1.6;
  }
...
const ICONS = {
  ...
  work:      "M20 6h-2.18c.07-.44.18-.88.18-1.36 0-2.59-2.12-4.64-4.73-4.64C11.1 0 9.34 1.3 8.41 3.12L8 3.93l-.41-.81C6.66 1.3 4.9 0 2.73 0 .12 0-2 2.05-2 4.64c0 .48.11.92.18 1.36H-2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V6z",
      ...
      <div style={{ maxWidth: 700, margin: "0 auto", display: "flex", flexDirection: "column", gap: 48 }}>
        ...
        <div>
          ...
          <Timeline position="left">
            {[
              ...
              { label: "Repeat", color: "success" as const },
            ].map(({ label, color }, i) => (
        ...
        <div>
          ...
          <Timeline position="alternate">
            ...
            <TimelineItem>
              <TimelineSeparator>
                <TimelineDot color="success"><Icon d={ICONS.repeat} size={16} color="#fff" /></TimelineDot>
              </TimelineSeparator>
              <TimelineContent>
                <p className="tl-title">Repeat</p>
              </TimelineContent>
        ...
        <div>
          ...
          <Timeline position="alternate">
            {[
              ...
              { time: "06:00 pm", event: "Pack up & ship", body: "Deploy to production",  color: "success"   as const, icon: ICONS.check    },
        ...
        <div>
          ...
          <Timeline position="alternate">
            {[
              ...
              { year: "2024", title: "IPO",          body: "Listed on NASDAQ. What a ride.",              color: "warning" as const },
        ...
        <div>
          ...
          <Timeline>
            ...
            <TimelineItem>
              ...
              <TimelineContent><p className="tl-title">Step 3 · Test</p></TimelineContent>
            </TimelineItem>
            <TimelineItem>
              <TimelineSeparator>
                <TimelineDot color="warning" />
              </TimelineSeparator>
              <TimelineContent><p className="tl-title">Step 4 · Deploy</p></TimelineContent>
            </TimelineItem>
          </Timeline>
        </div>
