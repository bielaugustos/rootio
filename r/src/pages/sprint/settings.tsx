...
export function SprintSettingsPage() {
  ...
  return (
    <PageWrapper maxWidth={600}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-title)', fontSize: 28, color: 'var(--t1)' }}>Ajustes · Sprint</h1>
      </div>
      ...
      <div style={{ background: 'var(--secondary-background)', border: '2px solid var(--border)', borderRadius: 'var(--radius-lg)', boxShadow: '4px 4px 0 var(--border)', overflow: 'hidden' }}>
        <div style={{ padding: '12px 20px', borderBottom: '1px solid var(--b2)', fontSize: 10, fontWeight: 500, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--t3)' }}>
          PREFERÊNCIAS
        </div>
        <div style={{ padding: '20px', color: 'var(--t3)', fontSize: 14, fontStyle: 'italic' }}>
          Configurações específicas de Sprint serão adicionadas aqui.
        </div>
      </div>
    </PageWrapper>
  )
