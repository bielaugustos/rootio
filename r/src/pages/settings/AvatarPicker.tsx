        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12, width: '100%' }}>
          <div style={{
            ...
            >
              ...
              <span style={{ fontSize: 8, fontWeight: 500, color: 'var(--t3)', fontFamily: 'var(--font-sans)', lineHeight: 1 }}>
              </span>
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
      ...
      >
        ...
        <span style={{ fontSize: 7, fontWeight: 500, color: 'var(--t3)', fontFamily: 'var(--font-sans)', lineHeight: 1 }}>
        </span>
