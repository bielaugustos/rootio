    ...
    <PageWrapper>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
          ...
          <h3 style={{ fontSize: 16, fontWeight: 500, color: 'var(--t1)', margin: 0 }}>
      ...
      <Section title="Gerenciamento de Dados">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, padding: 16 }}>
          ...
          >
            ...
            <span style={{ fontSize: 14, fontWeight: 500, color: 'var(--t1)' }}>Exportar JSON</span>
          </div>
          <div style={{
            border: '2px solid var(--border)',
            borderRadius: 'var(--radius-base)',
          ...
          >
            ...
            <span style={{ fontSize: 14, fontWeight: 500, color: 'var(--t1)' }}>Exportar CSV</span>
          </div>
        </div>
      </Section>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
          ...
          <h3 style={{ fontSize: 16, fontWeight: 500, color: 'var(--destructive)', margin: 0 }}>
            Zona de Perigo
          </h3>
        </div>
        <p style={{ fontSize: 13, color: 'var(--t2)', lineHeight: 1.5, marginBottom: 16, marginTop: 0 }}>
        ...
        {confirmDelete ? (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <p style={{ fontSize: 13, color: 'var(--destructive)', fontWeight: 400, lineHeight: 1.5, margin: 0 }}>
