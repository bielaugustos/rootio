...
export function SyncPage() {
  ...
  return (
    <PageWrapper>
      ...
      <div style={{
        ...
        <div style={{ marginBottom: 16 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
            <span style={{ fontSize: 11, fontWeight: 500, color: 'var(--t3)', letterSpacing: '0.5px' }}>ARMAZENAMENTO</span>
      ...
      <div style={{ fontSize: 11, fontWeight: 500, color: 'var(--t3)', letterSpacing: '0.5px', marginBottom: 10 }}>DISPOSITIVOS CONECTADOS</div>
      ...
      {devices.map(d => (
        <div key={d.name} style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div>
              <div style={{ fontSize: 14, fontWeight: 500, color: 'var(--t1)' }}>{d.name}</div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14 }}>
          ...
          <div>
            <div style={{ fontSize: 14, fontWeight: 500, color: 'var(--t1)', marginBottom: 4 }}>Sessões Seguras</div>
      ...
      <div style={{ marginBottom: 32, marginTop: 32 }}>
        <div style={{ fontSize: 11, fontWeight: 500, color: 'var(--t3)', letterSpacing: '0.5px', marginBottom: 10 }}>
          TERMOS DE SERVIÇO
        </div>
          ...
          return (
            <div key={section.title} style={{
              ...
              >
                ...
                <span style={{ fontSize: 14, fontWeight: 500, color: 'var(--t1)', flex: 1 }}>
                  {section.title}
                </span>
