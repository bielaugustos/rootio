  ...
  return (
    <PageWrapper maxWidth={860}>
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 8 }}>
        <div>
          <h1 style={{ fontFamily: 'var(--font-title)', fontSize: 28, color: 'var(--t1)', marginBottom: 4 }}>Mentor</h1>
          <p style={{ color: 'var(--t3)', fontSize: 14, marginBottom: 24 }}>Conecte-se com mentores e acompanhe sua evolução guiada.</p>
        </div>
        <button
