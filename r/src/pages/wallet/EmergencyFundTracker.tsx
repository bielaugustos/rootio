    ...
    <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 12 }}>
          <div>
            <div style={{ fontSize: 10, fontWeight: 500, color: 'var(--t3)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 4 }}>Guardado</div>
            <div style={{ fontSize: 26, fontWeight: 700, fontFamily: 'var(--font-mono)', color, lineHeight: 1 }}>{fmtBRL(currentSavings)}</div>
          </div>
          <div style={{ textAlign: 'right' }}>
            <div style={{ fontSize: 10, fontWeight: 500, color: 'var(--t3)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 4 }}>Meta</div>
            <div style={{ fontSize: 16, fontWeight: 500, fontFamily: 'var(--font-mono)', color: 'var(--t2)' }}>{fmtBRL(totalGoal)}</div>
          </div>
        </div>
        ...
        <div style={{ border: '2px solid var(--border)', borderRadius: 'var(--radius-base)', background: 'var(--secondary-background)', boxShadow: '4px 4px 0 var(--border)', overflow: 'hidden' }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 500, color: 'var(--t2)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                ...
                return (
                  <div key={a.id} style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                      ...
                      <div>
                        <div style={{ fontSize: 13, fontWeight: 500, color: 'var(--t1)', fontFamily: 'var(--font-mono)' }}>
                          {fmtBRL(a.value)}
                        </div>
