...
function NavItem({
  ...
  return (
    ...
    >
      ...
      {isExpanded && (
        <span style={{ fontSize: 13, fontWeight: 500, fontFamily: 'var(--font-sans)', flex: 1 }}>{label}</span>
      )}
    </NavLink>
  )
}
    ...
    <>
      ...
      >
        ...
        <nav style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', padding: '6px 0' }}>
          ...
          {isExpanded && (
            <div style={{ padding: '2px 16px 2px', fontSize: 10, fontWeight: 500, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--t3)', whiteSpace: 'nowrap' }}>
              Sistema
            </div>
          )}
        ...
        <div style={{
          ...
          {isExpanded && (
            <div style={{ minWidth: 0 }}>
              <div style={{ fontSize: 13, fontWeight: 400, color: 'var(--t1)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
