    ...
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', padding: 20, gap: 12 }}>
      ...
      {goals.length > 0 && (
        <div style={{ marginTop: 'auto' }}>
          <div style={{ fontSize: 10, fontWeight: 500, color: 'var(--t3)', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 8 }}>Metas</div>
            ...
            {goals.slice(0, 2).map(goal => {
              ...
              return (
                <div key={goal.id} style={{
                  ...
                  <div style={{ fontSize: 11, fontWeight: 500, color: 'var(--t1)', marginBottom: 2 }}>{goal.name}</div>
                  ...
                  {urgent && (
                    <div style={{ fontSize: 8, fontWeight: 500, color: '#dc2626', marginTop: 2 }}>
                      Vence em breve
                    </div>
                  )}
                </div>
