  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', padding: 20, gap: 14 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <div>
          <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--t1)' }}>Streak</div>
          <div style={{ fontSize: 10, fontWeight: 700, color: 'var(--t3)', textTransform: 'uppercase', letterSpacing: '0.1em' }}>dias seguidos</div>
        </div>
      </div>

      <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
        <span style={{ fontSize: 36, fontWeight: 900, fontFamily: 'var(--font-mono)', color: 'var(--t1)', lineHeight: 1 }}>{streak}</span>
        <span style={{ fontSize: 12, color: 'var(--t3)', fontWeight: 600 }}>dias</span>
      </div>
