  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', padding: 20, gap: 14 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <div>
          <div style={{ fontSize: 20, fontWeight: 900, fontFamily: 'var(--font-mono)', color: 'var(--t1)', lineHeight: 1 }}>{weekPct}%</div>
          <div style={{ fontSize: 10, fontWeight: 700, color: 'var(--t3)', textTransform: 'uppercase', letterSpacing: '0.1em', marginTop: 2 }}>semana completa</div>
        </div>
      </div>
      ...
      <div style={{
        ...
        borderRadius: 'var(--radius-sm)', fontSize: 11, color: 'var(--t2)', fontWeight: 600,
      }}>
