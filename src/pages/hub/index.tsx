    ...
    <PageWrapper maxWidth={640}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 6, marginBottom: 20 }}>
          <span style={{ fontSize: 36, fontWeight: 900, color: 'var(--t1)', fontFamily: 'var(--font-mono, monospace)' }}>
            {economy !== null ? economy.io_saldo.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : '—'}
          </span>
          <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--t3)' }}>IO</span>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 24 }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--t1)' }}>Hábito Concluído</div>
          <div style={{ fontSize: 14, fontWeight: 900, color: 'var(--main)' }}>+50 XP</div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--t1)' }}>Upvotes Recebidos</div>
          <div style={{ fontSize: 14, fontWeight: 900, color: 'var(--main)' }}>+15 XP</div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--t1)' }}>Nova Insígnia</div>
            <div style={{ fontSize: 12, color: 'var(--t3)' }}>Explorador Matinal</div>
          </div>
          <div style={{ fontSize: 14, fontWeight: 900, color: 'var(--main)', flexShrink: 0 }}>+200 XP</div>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, marginBottom: 32 }}>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 12, fontWeight: 700, color: 'var(--t1)', textAlign: 'center' }}>Foco Total</span>
        </div>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 12, fontWeight: 700, color: 'var(--t1)', textAlign: 'center' }}>Mentor Root</span>
        </div>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 12, fontWeight: 700, color: 'var(--t1)', textAlign: 'center' }}>???</span>
        </div>
      </div>
    </PageWrapper>
  )
