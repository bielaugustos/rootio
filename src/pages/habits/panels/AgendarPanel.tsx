      ...
      {open && (
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontSize: 13, fontWeight: 700, flex: 1 }}>Agendar</span>
            {saving && (
          ...
          <div style={{ padding: '14px', display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            {/* ── Quick presets ── */}
            <div>
              <div style={{ fontSize: 10, fontWeight: 700, color: 'var(--t3)', textTransform: 'uppercase', letterSpacing: '.08em', marginBottom: 7 }}>
                Atalhos
              </div>
