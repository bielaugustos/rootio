          ...
          <div style={{
            ...
            <div style={{ position: 'relative', width: 120, height: 120 }}>
              ...
              <div style={{
                ...
                <span style={{
                  fontSize: 26, fontWeight: 900, fontFamily: 'var(--font-mono, monospace)',
                  color: state === 'done' ? '#22c55e' : 'var(--t1)',
                  lineHeight: 1,
                }}>
                  {state === 'done' ? '✓' : fmt(remaining)}
                </span>
                <span style={{ fontSize: 9, fontWeight: 700, color: 'var(--t3)', marginTop: 3, textTransform: 'uppercase', letterSpacing: '.06em' }}>
            ...
            <div style={{
              ...
              {sessions.slice(0, 4).map((s, i) => (
                <div key={i} style={{ display: 'flex', gap: 8, alignItems: 'center', fontSize: 11, color: 'var(--t2)' }}>
                  <span>🍅</span>
                  <span style={{ fontFamily: 'var(--font-mono)', fontWeight: 700 }}>{s.mins}min</span>
