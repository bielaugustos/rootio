    ...
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{ fontSize: 15, fontWeight: 500, color: 'var(--t1)' }}>{formTitle}</span>
        </div>
      ...
      <div style={{ padding: '24px 20px', display: 'flex', flexDirection: 'column' }}>
        ...
        {mode === 'transaction' && (
          <>
            ...
            <div style={{
              ...
              <span style={{ fontSize: 12, fontWeight: 400, color: isIncome ? '#15803d' : '#b91c1c' }}>
          ...
          <>
            ...
            {goalTarget > 0 && (
              <div style={{ marginBottom: 20 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6, fontSize: 11, color: 'var(--t3)', fontWeight: 400 }}>
                  <span>Progresso</span>
        ...
        {mode === 'aport' && (
          <>
            ...
            {(editGoal || initialEmergency) && (() => {
              ...
              return (
                <div style={{
                  ...
                  <div style={{ fontSize: 13, fontWeight: 500, color: 'var(--t1)', marginBottom: 8 }}>{name}</div>
                  <div style={{ display: 'flex', gap: 16, marginBottom: 10 }}>
                    <div style={{ flex: 1, textAlign: 'center' }}>
                      <div style={{ fontSize: 10, fontWeight: 500, color: 'var(--t3)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Guardado</div>
                    ...
                    <div style={{ flex: 1, textAlign: 'center' }}>
                      <div style={{ fontSize: 10, fontWeight: 500, color: 'var(--t3)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Restante</div>
                      <div style={{ fontSize: 14, fontWeight: 700, fontFamily: 'var(--font-mono)', color: 'var(--t1)', marginTop: 2 }}>
                        {remaining.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL', minimumFractionDigits: 0 })}
                      </div>
                    </div>
                    <div style={{ width: 1, background: 'var(--b2)' }} />
                    <div style={{ flex: 1, textAlign: 'center' }}>
                      <div style={{ fontSize: 10, fontWeight: 500, color: 'var(--t3)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Meta</div>
                      <div style={{ fontSize: 14, fontWeight: 700, fontFamily: 'var(--font-mono)', color: 'var(--t2)', marginTop: 2 }}>
            ...
            {emergencyTarget > 0 && (() => {
              ...
              return (
                <div style={{ marginBottom: 20 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 11, color: 'var(--t3)', fontWeight: 400, marginBottom: 6 }}>
        ...
        {saveError && (
          <div style={{
            ...
            borderRadius: 'var(--radius-sm)', fontSize: 12, color: '#b91c1c', fontWeight: 400,
