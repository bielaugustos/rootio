    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 14, fontWeight: 700, color: 'var(--t1)' }}>Plano Pro ativo</div>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <i className="ph ph-crown-simple" style={{ color: '#fff', fontSize: 16, flexShrink: 0 }} />
        <span style={{ fontSize: 14, fontWeight: 900, color: '#fff', flex: 1 }}>Pro vitalício</span>
        <span style={{
        ...
        <span style={{ fontSize: 18, fontWeight: 900, color: '#fff', lineHeight: 1 }}>R$ 12,90</span>
      </div>
      ...
      <div style={{
        ...
        {['Hábitos ilimitados', 'Sync entre dispositivos', 'Todos os temas', 'Acesso vitalício', 'IA em breve', 'Suporte prioritário'].map(f => (
          <div key={f} style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: 12, color: 'var(--t2)' }}>
            <span style={{
              width: 14, height: 14, borderRadius: '50%', flexShrink: 0,
              background: '#f59e0b', border: '2px solid var(--border)',
      ...
      <div style={{ padding: '12px 20px', display: 'flex', gap: 12 }}>
        <Button label="Ativar Pro" variant="reverse" onClick={onNavigateShop} />
        <Button
          label="WhatsApp"
          variant="neutral"
          onClick={() => window.open('https://wa.me/?text=Quero+ativar+o+Pro+do+Rootio', '_blank')}
        />
      </div>
    </div>
  )
    ...
    <PageWrapper>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <div>
            <h1 style={{ fontSize: 28, color: 'var(--t1)', marginBottom: 4, fontFamily: 'var(--font-title)' }}>Configurações</h1>
            <p style={{ color: 'var(--t2)', fontSize: 15 }}>Preferências e configurações da conta.</p>
          </div>
        </div>
        {saved && (
          <span style={{
        ...
        <div style={{
          ...
          {[
            ...
            <div key={item.label} style={{
              ...
              <span style={{ fontSize: 16, fontWeight: 900, color: 'var(--t1)' }}>{item.value}</span>
      ...
      <img src='/illustrations/settingscat.png' alt='purple cat' style={{ width: 120, height: 120, margin: 'auto', marginBottom: '40px' }} />
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, opacity: 0.5 }}>
          ...
          <span style={{ fontSize: 16, fontWeight: 900, color: 'var(--t1)', fontFamily: 'var(--font-sans)', letterSpacing: '-0.02em' }}>
            rootio
          </span>
        </div>
        <Button
