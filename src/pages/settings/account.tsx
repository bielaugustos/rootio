    ...
    <PageWrapper>
      ...
      <Section title="Informações pessoais">
        <div style={{ padding: '14px 20px', borderBottom: '1px solid var(--b2)', background: 'var(--secondary-background)' }}>
          <div style={{ fontSize: 14, fontWeight: 600, color: 'var(--t1)', marginBottom: 2 }}>Nome de usuário</div>
        ...
        <div style={{ padding: '14px 20px', borderBottom: '1px solid var(--b2)', background: 'var(--secondary-background)' }}>
          <div style={{ fontSize: 14, fontWeight: 600, color: 'var(--t1)', marginBottom: 2 }}>@Username</div>
        ...
        <div style={{ padding: '14px 20px', borderBottom: '1px solid var(--b2)', background: 'var(--secondary-background)' }}>
          <div style={{ fontSize: 14, fontWeight: 600, color: 'var(--t1)', marginBottom: 2 }}>E-mail</div>
        ...
        <div style={{ padding: '14px 20px', background: 'var(--secondary-background)' }}>
          <div style={{ fontSize: 14, fontWeight: 600, color: 'var(--t1)', marginBottom: 2 }}>Bio</div>
