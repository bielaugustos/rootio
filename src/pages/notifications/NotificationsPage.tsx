    ...
    <div style={{
      ...
      <div style={{ position: 'relative', marginBottom: 16 }}>
        ...
        <div style={{
          ...
          border: '2px solid var(--border)',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          fontSize: 10, fontWeight: 700, color: 'var(--main-foreground)',
        }}>
          0
        </div>
      </div>
      <h3 style={{ fontSize: 18, fontWeight: 900, color: 'var(--t1)', marginBottom: 8 }}>
        Nada por aqui!
      </h3>
      ...
      {showSettings && (
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontSize: 11, fontWeight: 700, color: 'var(--main-foreground)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
              Permissões
            </span>
          </div>
          <PermRow
