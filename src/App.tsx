...
function AppWithNav() {
  ...
  useEffect(() => {
    getProfile().then(p => setShowEditor(p.show_editor ?? true))
  ...
  const commandItems: CommandItem[] = [
    ...
    { id: 'nav-career',   label: 'Carreira',     description: 'Metas profissionais',    iconClass: 'ph-briefcase',      group: 'Navegar', onSelect: () => navigate('/career') },
    ...
    { id: 'nav-mentor',   label: 'Mentor',       description: 'Mentoria guiada',        iconClass: 'ph-users-three',    group: 'Navegar', onSelect: () => navigate('/mentor') },
    { id: 'nav-projects', label: 'Projetos',     description: 'Iniciativas e projetos', iconClass: 'ph-folder-notch',   group: 'Navegar', onSelect: () => navigate('/projects') },
    { id: 'nav-sprint',   label: 'Sprint',       description: 'Ciclos de foco',         iconClass: 'ph-lightning',      group: 'Navegar', onSelect: () => navigate('/sprint') },
    { id: 'nav-shop',     label: 'Loja',         description: 'Recursos premium',       iconClass: 'ph-storefront',     group: 'Navegar', onSelect: () => navigate('/shop') },
